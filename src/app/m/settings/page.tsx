...
import { RefreshCw, FolderOpen, Loader2, Shield, CheckCircle2, BarChart3, Settings, LogOut } from 'lucide-react';
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          ...
          <div className="space-y-2 text-xs">
            <div>
              <span className="text-zinc-500">Claude Data:</span>
              <span className="font-mono ml-2">~/.claude/</span>
            </div>
            <div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          ...
          <p className="text-[11px] text-zinc-500 mb-3">
            Re-scan all Claude Code sessions.
          </p>
          <button
            onClick={handleSync}
